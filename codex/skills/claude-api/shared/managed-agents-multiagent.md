...
For per-language bindings beyond Python, use Codex web to fetch `https://platform.claude.com/docs/en/managed-agents/multi-agent.md` (see `shared/live-sources.md`).
