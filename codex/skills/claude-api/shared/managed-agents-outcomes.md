...
For the raw HTTP shapes and per-language SDK bindings beyond Python, use Codex web to fetch `https://platform.claude.com/docs/en/managed-agents/define-outcomes.md` (see `shared/live-sources.md`).
