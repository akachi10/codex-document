/**
 * Question Registry — typed schema for request_user_input invocations across gstack.
 *
 * Purpose
 * -------
 * Every request_user_input invocation is tagged with a stable question_id that maps
 ...
 *
 * Not every request_user_input in gstack needs a registry entry right away. Skills
