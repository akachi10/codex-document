 ...
 * stop-gate via request_user_input when artifacts_sync_mode is unset and gbrain
...
${isBrainHost ? `If output shows \`ARTIFACTS_SYNC: artifacts repo detected\`, offer \`gstack-brain-restore\` via request_user_input; otherwise continue.` : ''}
