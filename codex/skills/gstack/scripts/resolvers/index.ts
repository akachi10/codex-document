...
import { generateReviewDashboard, generatePlanFileReviewReport, generateleave Plan modeGate, generateAntiShortcutClause, generateSpecReviewLoop, generateBenefitsFrom, generateCodexSecondOpinion, generateAdversarialStep, generateCodexPlanReview, generateCodexDocReview, generatePlanCompletionAuditShip, generatePlanCompletionAuditReview, generatePlanVerificationExec, generateScopeDrift, generateCrossReviewDedup } from './review';
...
export const RESOLVERS: Record<string, ResolverValue> = {
  ...
  EXIT_PLAN_MODE_GATE: generateleave Plan modeGate,
