...
**request_user_input with pre-filled context:** Pre-fill what you inferred from the codebase,
...
Use request_user_input to confirm before spending API credits:
...
After receiving feedback (via HTTP POST or request_user_input fallback), output a clear
...
Use request_user_input to confirm before saving.
...
If standalone, offer next steps via request_user_input:
