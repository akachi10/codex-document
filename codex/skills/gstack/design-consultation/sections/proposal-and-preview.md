...
**request_user_input Q2 — present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused request_user_input. After the user decides, re-check coherence with the rest of the system.
...
**request_user_input Q-final — show summary and confirm:**
