...
- Bump VERSION without asking — always use request_user_input for version changes
...
> **STOP.** Before auditing each doc file and applying updates, polishing CHANGELOG voice, checking cross-doc consistency, cleaning up TODOS, the VERSION bump, and committing (Steps 2-9, after the coverage map in Step 1.5), Read `~/.codex/skills/gstack/document-release/sections/release-body.md` and execute it
