...
`STOP. request_user_input` anywhere, pace one question per turn — emit the question as
...
skill has no `STOP. request_user_input` directive AND (b) you need multiple unrelated
