...
### 9. The request_user_input Redundancy
...
**Fix:** The skill template must say: "Do NOT use request_user_input to ask the user's
preference. Read `feedback.json`, it contains their selection. Only request_user_input
...
3. Agent uses request_user_input: "I've opened the design board. Which variant
