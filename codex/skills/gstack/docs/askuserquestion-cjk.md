# request_user_input — non-ASCII / CJK characters

Read this on demand when an request_user_input contains Chinese (繁體/簡體),
Japanese, Korean, or other non-ASCII text. The operative rule is in the
always-loaded request_user_input self-check ("Non-ASCII characters written directly,
