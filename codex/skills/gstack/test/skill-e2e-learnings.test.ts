...
- The bin scripts are at ./bin/ (relative to this directory), not at ~/.codex/skills/gstack/bin/.
  Replace any references to ~/.codex/skills/gstack/bin/ with ./bin/ when running commands.
- Replace any references to ~/.codex/skills/gstack/bin/gstack-slug with ./bin/gstack-slug.
