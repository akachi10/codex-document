/**
 * /plan-design-review per-finding request_user_input count (periodic, paid, real-PTY).
 *
...
describeE2E('/plan-design-review per-finding request_user_input count (periodic)', () => {
  test(
    `5-finding plan emits ${FLOOR}-${CEILING} review-phase request_user_inputs`,
    async () => {
      try {
