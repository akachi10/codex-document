 ...
 *   - mcp__*__request_user_input matcher acceptance
...
// ----------------------------------------------------------------------
// Native request_user_input capture
// ----------------------------------------------------------------------

describe('PostToolUse hook (native request_user_input)', () => {
...
// ----------------------------------------------------------------------
// MCP request_user_input variant (Conductor)
// ----------------------------------------------------------------------

describe('PostToolUse hook (mcp__*__request_user_input variant)', () => {
  test('accepts mcp__conductor__request_user_input tool_name', () => {
    const r = runHook({
      session_id: 'sess3',
      tool_name: 'mcp__conductor__request_user_input',
      tool_use_id: 'tu-3',
      tool_input: {
