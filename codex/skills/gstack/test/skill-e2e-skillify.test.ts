...
Do NOT enter the prototype phase. Do NOT use request_user_input.`,
...
2. Run /skillify via the Skill tool. Follow ALL 11 steps including:
   ...
   - When request_user_input fires, choose the recommended option (A)
...
2. Run /skillify via the Skill tool. Follow steps 1-9. When the approval
   gate request_user_input fires (Step 9), choose option C (Discard) instead
