...
describe('isPermissionDialogVisible', () => {
  ...
  test('does NOT match a skill request_user_input list', () => {
    const sample = `
...
describe('classifyVisible (runtime path through the runner classifier)', () => {
  ...
  // model writes findings to the plan file before any request_user_input fires.
...
describe('Step0BoundaryPredicate per-skill', () => {
  ...
  function fp(promptSnippet: string, optionLabels: string[]): request_user_inputFingerprint {
