...
Read pitch.md — that's the founder pitch the user is bringing to office hours. Select Startup Mode. Skip any request_user_input — this is non-interactive.
...
Read idea.md — that's the user's weekend project idea. Select Builder Mode (Phase 2B). Skip any request_user_input — this is non-interactive.
