/**
 * /plan-devex-review per-finding request_user_input count (periodic, paid, real-PTY).
 *
...
describeE2E('/plan-devex-review per-finding request_user_input count (periodic)', () => {
  test(
