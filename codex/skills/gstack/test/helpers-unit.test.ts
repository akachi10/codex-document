 ...
 *       Used by the request_user_input format-compliance and mode-routing tests to look
...
describe('parseNumberedOptions', () => {
  ...
  test('anchors on LAST cursor when both stale and fresh fit in the tail', () => {
    ...
    // permission dialog options come first, the real request_user_input comes second.
