 ...
 *    review plan to ~/.claude/plans/ and called leave Plan mode without
 *    ever firing request_user_input."
 *
 ...
 * legitimate reason to batch them into a single request_user_input.
 *
 ...
 * "## Decisions to confirm" section + leave Plan mode). Floor of 3 (not 4) is
 ...
 * sequential request_user_input calls (or batch into compatible ≤4-groups),
